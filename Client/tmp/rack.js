...
function buildElevationRows(rack) {
  ...
  (rack.cable_management ?? []).forEach(
    (item) => register("cable_management", item)
  );
  const rows = [];
...
function Rack() {
  ...
  const invalidateRack = () => queryClient.invalidateQueries({ queryKey: ["rack-contents", rackId] });
  ...
  const createCableMutation = useMutation({
    ...
    onError: (err) => {
      toast.error(
        err.response?.data?.message || "Fout bij aanmaken van cable management item"
      );
    }
  });
  const updateCableMutation = useMutation({
    ...
    onError: (err) => {
      toast.error(
        err.response?.data?.message || "Fout bij bijwerken van cable management item"
      );
    }
  });
  const deleteCableMutation = useMutation({
    ...
    onError: (err) => {
      toast.error(
        err.response?.data?.message || "Fout bij verwijderen van cable management item"
      );
    }
  });
  ...
  const bulkCreatePortsMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast.success(
        data?.length ? `${data.length} poorten aangemaakt` : "Poorten aangemaakt"
      );
    },
    onError: (err) => {
      toast.error(
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gray-50/50 pb-12" }, /* @__PURE__ */ React.createElement(Header, null), /* @__PURE__ */ React.createElement("div", { className: "max-w-4xl mx-auto px-4 sm:px-6" }, /* @__PURE__ */ React.createElement("nav", { className: "flex items-center gap-2 text-sm text-gray-500 mb-4 pt-2" }, /* @__PURE__ */ React.createElement(
    Link,
    {
      to: `/klanten/${klantId}`,
      className: "inline-flex items-center gap-1.5 hover:text-gray-800 transition font-medium"
    },
    /* @__PURE__ */ React.createElement(FiArrowLeft, { className: "text-base" }),
    "Terug"
  ), /* @__PURE__ */ React.createElement(FiChevronRight, { className: "text-gray-300" }), /* @__PURE__ */ React.createElement("span", { className: "text-gray-800 font-medium" }, isLoading ? "Laden..." : rack?.name ?? "Rack")), isLoading ? /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-gray-200 p-8 text-center text-sm text-gray-400" }, "Laden...") : !rack ? /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-gray-200 p-8 text-center text-sm text-gray-400" }, "Rack niet gevonden.") : /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center" }, /* @__PURE__ */ React.createElement("div", { className: "mb-4 text-center" }, /* @__PURE__ */ React.createElement("h1", { className: "text-lg font-semibold text-gray-900" }, rack.name), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-400 mt-1" }, rack.height_u, "U", rack.notes ? ` \u2014 ${rack.notes}` : "")), /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-sm flex items-center justify-between mb-2 gap-2" }, /* @__PURE__ */ React.createElement(
    "form",
    {
    ...
    /* @__PURE__ */ React.createElement(FiPlus, null),
    " Cable"
  ))), /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-sm bg-white rounded-xl border border-gray-300 shadow-sm overflow-hidden" }, elevationRows.map((row) => {
    if (row.type === "empty") {
      return /* @__PURE__ */ React.createElement(
        "div",
        {
          key: `u-${row.u}`,
          className: `h-7 flex items-center border-b border-gray-100 last:border-b-0 ${row.u % 2 === 0 ? "bg-gray-50/50" : "bg-white"}`
        },
        /* @__PURE__ */ React.createElement("span", { className: "w-9 shrink-0 text-right pr-2 text-[10px] font-medium text-gray-400 tabular-nums" }, row.u, "U"),
        /* @__PURE__ */ React.createElement("span", { className: "flex-1 h-full border-l border-gray-100" })
      );
    }
    const item = row.item;
    const units = Number(item.rack_units ?? 1);
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "w-9 shrink-0 text-right pr-2 text-[10px] font-medium tabular-nums" }, topU, "U"),
      /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
        ...
        /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs font-semibold truncate" }, item.label), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] truncate opacity-75" }, kindLabels[itemKind], " \xB7 ", units, "U", itemKind === "patch_panel" && item.port_count ? ` \xB7 ${item.port_count} poorten` : ""))
      )
    );
  })), selectedItem && /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-3xl mt-6 bg-white rounded-2xl border border-slate-200 p-5 shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-[11px] uppercase tracking-[0.12em] text-slate-400 font-semibold" }, selectedItem.kind === "device" ? "Device" : selectedItem.kind === "patch_panel" ? "Patch panel" : "Cable management"), /* @__PURE__ */ React.createElement("h2", { className: "text-lg font-semibold text-slate-800" }, selectedItem.item.label)), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      onClick: () => {
    ...
    /* @__PURE__ */ React.createElement(FiEdit2, { className: "text-xs" }),
    " Bewerken"
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React.createElement(FiTrash2, { className: "text-xs" }),
    " Verwijderen"
  ))), /* @__PURE__ */ React.createElement("div", { className: "mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-slate-600" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Positie"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.rack_position, "U \u2014", " ", selectedItem.item.rack_units || 1, "U")), selectedItem.kind === "device" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Type"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, deviceTypeMap.get(
    selectedItem.item.device_type_id
  ) || "Onbekend")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Fabrikant"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.manufacturer || "-")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Model"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.model || "-")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Serienummer"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.serial_number || "-")), /* @__PURE__ */ React.createElement("div", { className: "sm:col-span-2" }, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "MAC-adres"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.mac_address || "-"))), selectedItem.kind === "patch_panel" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Type"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.type || "-")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Aantal poorten"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.port_count || 0)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Fabrikant"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.manufacturer || "-")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Model"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.model || "-"))), selectedItem.kind === "cable_management" && /* @__PURE__ */ React.createElement("div", { className: "sm:col-span-2" }, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Type"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800" }, selectedItem.item.type || "-")), (selectedItem.item.notes || "") && /* @__PURE__ */ React.createElement("div", { className: "sm:col-span-2" }, /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] uppercase tracking-[0.12em] text-slate-400 mb-1" }, "Opmerking"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-800 whitespace-pre-wrap" }, selectedItem.item.notes))), selectedItem.kind !== "cable_management" && /* @__PURE__ */ React.createElement("div", { className: "mt-6 border-t border-slate-200 pt-5" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-3 mb-3" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-semibold text-slate-800" }, "Poorten"), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-400" }, selectedPorts.length, " totaal")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 mb-4" }, selectedPorts.length === 0 ? /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-400" }, "Geen poorten aangemaakt.") : selectedPorts.map((port) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: port.id,
    ...
    /* @__PURE__ */ React.createElement("span", null, port.name),
    /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ React.createElement("label", { className: "flex flex-col gap-1 text-[11px] font-medium text-slate-600" }, "Aantal", /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        min: "1",
        value: portForm.count,
        onChange: (e) => setPortForm((prev) => ({
          ...prev,
    ...
    /* @__PURE__ */ React.createElement("label", { className: "flex flex-col gap-1 text-[11px] font-medium text-slate-600" }, "Prefix", /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
    ...
    /* @__PURE__ */ React.createElement("label", { className: "flex flex-col gap-1 text-[11px] font-medium text-slate-600" }, "Type", /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
    ...
    /* @__PURE__ */ React.createElement("label", { className: "flex flex-col gap-1 text-[11px] font-medium text-slate-600" }, "Snelheid", /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
    ...
    /* @__PURE__ */ React.createElement("div", { className: "md:col-span-4 flex justify-end" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "submit",
      ...
      bulkCreatePortsMutation.isPending ? "Aanmaken..." : "Poorten aanmaken"
    ))
  ))))), /* @__PURE__ */ React.createElement(
    FormModal,
    {
      ...
      isSubmitting: createDeviceMutation.isPending || updateDeviceMutation.isPending
    }
  ), /* @__PURE__ */ React.createElement(
    FormModal,
    {
      ...
      initialValues: editingPatchPanel ? {
      ...
      isSubmitting: createPatchPanelMutation.isPending || updatePatchPanelMutation.isPending
    }
  ), /* @__PURE__ */ React.createElement(
    FormModal,
    {
      ...
      title: editingCable ? "Cable management bewerken" : "Nieuw cable management item",
      fields: cableFields,
      initialValues: editingCable ? {
      ...
      isSubmitting: createCableMutation.isPending || updateCableMutation.isPending
    }
  ), /* @__PURE__ */ React.createElement(
    Modal,
    {
    ...
    /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Weet je zeker dat je ", /* @__PURE__ */ React.createElement("strong", null, deleteDeviceTarget?.label), " wilt verwijderen?", /* @__PURE__ */ React.createElement("span", { className: "text-xs text-red-500 mt-2 block font-medium" }, "Let op: de poorten van dit device gaan mee weg (CASCADE).")),
    /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex justify-end gap-3" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      deleteDeviceMutation.isPending ? "Verwijderen..." : "Device verwijderen"
    ))
  ), /* @__PURE__ */ React.createElement(
    Modal,
    {
    ...
    /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Weet je zeker dat je ", /* @__PURE__ */ React.createElement("strong", null, deletePatchPanelTarget?.label), " ", "wilt verwijderen?", /* @__PURE__ */ React.createElement("span", { className: "text-xs text-red-500 mt-2 block font-medium" }, "Let op: de poorten van dit patch panel gaan mee weg.")),
    /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex justify-end gap-3" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      {
        type: "button",
        onClick: () => deletePatchPanelMutation.mutate(deletePatchPanelTarget.id),
        disabled: deletePatchPanelMutation.isPending,
        className: "px-4 py-2 rounded-xl text-sm font-medium bg-red-600 hover:bg-red-700 text-white cursor-pointer disabled:opacity-50"
      },
      deletePatchPanelMutation.isPending ? "Verwijderen..." : "Patch panel verwijderen"
    ))
  ), /* @__PURE__ */ React.createElement(
    Modal,
    {
    ...
    /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Weet je zeker dat je ", /* @__PURE__ */ React.createElement("strong", null, deleteCableTarget?.label), " wilt verwijderen?"),
    /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex justify-end gap-3" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      deleteCableMutation.isPending ? "Verwijderen..." : "Item verwijderen"
    ))
  ));
}
export {
